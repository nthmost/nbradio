...
TAG_NORMALIZE = {
    ...
    # Common MusicBrainz lowercase tags (not in ID3 collection but common in MB)
    "punk":                          ("Punk", "Punk"),
    "rock":                          ("Pop/Rock", "Rock"),
    "jazz":                          ("Jazz", "Cool Jazz"),
    "metal":                         ("Metal", "Heavy Metal"),
    "ambient":                       ("Chill", "Ambient"),
    "soul":                          ("Blues/Soul", "Soul"),
    "funk":                          ("Blues/Soul", "Funk"),
    "reggae":                        ("Dub/Reggae", "Reggae"),
    "dub":                           ("Dub/Reggae", "Dub"),
    "drum and bass":                 ("Bass", "Drum & Bass"),
    "dnb":                           ("Bass", "Drum & Bass"),
    "garage":                        ("Bass", "Garage"),
    "grime":                         ("Bass", "Grime"),
    "hardcore":                      ("Punk", "Hardcore"),
    "post-punk":                     ("Punk", "Post-Punk"),
    "industrial":                    ("Electronic", "Breakbeat"),
    "new wave":                      ("Pop/Rock", "Pop"),
    "indie":                         ("Pop/Rock", "Indie"),
    "indie rock":                    ("Pop/Rock", "Indie"),
    ...
    "doom metal":                    ("Metal", "Doom"),
    "thrash metal":                  ("Metal", "Thrash"),
    "stoner rock":                   ("Metal", "Stoner/Sludge"),
    "sludge metal":                  ("Metal", "Stoner/Sludge"),
    "grunge":                        ("Pop/Rock", "Rock"),
    "shoegaze":                      ("Pop/Rock", "Indie"),
    "post-rock":                     ("Pop/Rock", "Rock"),
    "psychedelic":                   ("Pop/Rock", "Rock"),
    "experimental":                  ("Electronic", "IDM"),
    "noise":                         ("Electronic", "IDM"),
    "synthwave":                     ("Electronic", "House"),
    "synth-pop":                     ("Electronic", "House"),
    "disco":                         ("Electronic", "House"),
    "electro":                       ("Electronic", "Breakbeat"),
    "glitch":                        ("Electronic", "Glitch Hop"),
